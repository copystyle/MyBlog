        ...
        <div class="side">
          ...
          <side-section>
            <div slot="sidecontent">
              ...
              <li class="message-item" v-for="item in messagesList" :key="item">
          ...
          <side-section>
            <div slot="sidecontent">
              ...
              <div class="tags">
                <span class="tags-item" v-for="item in tags" :key="item"><a href="#" @click="getOne(item.tag)">{{item.tag}}</a></span>
              </div>
            </div>
          </side-section>
